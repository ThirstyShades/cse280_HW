...
|$\neg \exists x \ S(x)$|There exists NOT a person who is a student|
|$\exists x \ \neg S(x)$|There exists a person who is NOT a student|
|$\neg \forall x \ \neg S(x)$|NO people are NOT students.|
...
* X All people are both students and from Nepal.
* X All of my friends are cool.                    
* X Some of my friends are cool.
* X Some student is from Nepal.
* X Someone is my friend and is cool.
* X All students are from Nepal.
* X Everyone is a friend and is cool.
